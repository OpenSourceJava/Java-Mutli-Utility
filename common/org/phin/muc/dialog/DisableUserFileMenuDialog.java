...
public class DisableUserFileMenuDialog extends MultiUtilityDialog {
	...
	public DisableUserFileMenuDialog() {
		this.createGUI();
	}
	...
	protected void createGUI() {
		...
		// title set
		super.setTitle("Disable User's File Menu");
		
		if (Strings.userMenuOptions != null) {
			Strings.userMenuOptions.setEnabled(false);
		}
	...
	public void dispose() {
		...
		if (Strings.userMenuOptions != null) {
			Strings.userMenuOptions.setEnabled(true);
		}
